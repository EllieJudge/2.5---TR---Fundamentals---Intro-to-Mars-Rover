...
Special thanks to [Jimminey Heggs](https://github.com/eggsy84) for helping me solve this issue and also allowing me to spend time on this project and to [madge!](https://www.npmjs.com/package/madge)) for creating a cool way to check for Circular Dependencies. 
